...
public class PetTestClass {
   ...
   Pet pet = new Pet(001,category,"Vivek",photoUrl, tagsList,"sold");
        ...
        objectMapper.writeValue(new File("src\\test\\java\\PetStore\\PetSerializeClass\\ariet.json"),pet);
        ...
        objectMapper.writeValue(new File("src\\test\\java\\ArietProject\\family.json"), pet);
